<x-guest-layout>
    <x-auth-card>
        ...
        <div class="mt-6">
            ...
            <div class="grid mt-6">
              <div>
                <a href="{{url('/register')}}" class="inline-flex justify-center w-full px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
                Create Account
                </a>
              </div>
            </div>
